...
parser = argparse.ArgumentParser(description="This script demonstrates a UR10 robot arm.")
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # Create a specific origin for the UR10 robot
    # Ground-plane
...
def main():
    ...
    # Design the scene with only the UR10 robot
